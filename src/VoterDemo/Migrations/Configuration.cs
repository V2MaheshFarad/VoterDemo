namespace VoterDemo.Migrations
{
    using VoterDemo.DAL;
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<VoterDemo.DAL.DataContext>
    {
        ...
        protected override void Seed(VoterDemo.DAL.DataContext context)
        {
